...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover table-condensed">
            ...
            $dados = $consulta->PDOSelecionar("*", "ZPortareCombustivel", $condicao, ($start+1), $end, "descricao");
            $d = new ArrayIterator($dados);
            $tr = $consulta->PDOQtderegistro("ZPortareCombustivel", $condicao); // Total de registros
