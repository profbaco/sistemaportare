...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover table-condensed">
            ...
            $dados = $consulta->PDOSelecionar("*", "ZPortareDregrupo", $condicao, ($start+1), $end, "id");
            $d = new ArrayIterator($dados);
            $tr = $consulta->PDOQtderegistro("ZPortareDregrupo", $condicao); // Total de registros
            ...
            while ($d->valid()){
                ...
                echo '<tr id="'.$path.$m->id.'">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-default btn-xs" rel="tooltip" title="Contas" onclick="abrirModal(\'montagem\', '.$m->id.' , \'view/dremontagem/list.php\')">
