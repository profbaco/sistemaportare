...
if ($acao =='inserir') {
     $consulta->PDOInserir("ZPortareDespesas", "(descricao, valor, tipo)", "('".$descricao."', '".$valor."', '".$tipo."')");
     echo '<script language="javascript">
                carregaPagina(\'view/'.$path.'/list.php?tipo='.$tipo.'\')
                $("#modalCadastro").modal("hide");
              </script>';

} elseif ($acao == 'editar') {
    $consulta->PDOEditar("ZPortareDespesas", "descricao='".$descricao."', valor='".$valor."'", "id = ".$id);
    ...
    if ($checa>0) {
        ...
        $consulta->PDOExcluir("ZPortareDespesas", "id = ".$id);
