...
if ($acao =='inserir') {
     $consulta->PDOInserir("ZPortareTelefones", "(idmotorista, operadora, numero)", "('".$idmotorista."', '".$operadora."', '".$numero."')");
    ...
    $consulta->PDOEditar("ZPortareTelefones", "idmotorista='".$idmotorista."', operadora='".$operadora."', numero='".$numero."'", "id = ".$id);
    ...
    if ($checa>0) {
        ...
        $consulta->PDOExcluir("ZPortareTelefones", "id = ".$id);
