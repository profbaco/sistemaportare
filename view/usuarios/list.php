...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover table-condensed">
            ...
            $dados = $consulta->PDOSelecionar("A.id, A.nome, A.email, B.nome perfil, CASE A.ativo WHEN 1 THEN 'Ativo' ELSE 'Inativo' END status", "ZPortareLogin A, ZPortarePerfil B", $condicao, ($start+1), $end, "A.nome");
            $d = new ArrayIterator($dados);
            $tr = $consulta->PDOQtderegistro("ZPortareLogin A, ZPortarePerfil B", $condicao); // Total de registros
