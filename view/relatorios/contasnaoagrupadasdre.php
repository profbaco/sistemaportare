...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-hover table-condensed">
            ...
            $condicao = "A.id NOT IN (SELECT X.id FROM ZPortareDremontagem X WITH (NOLOCK))";
            ...
            $dados = $consulta->PDOSelecionar("A.codconta, A.codigo, B.DESCRICAO",
                "ZPortarePlanocontas A WITH (NOLOCK) JOIN CCONTA B ON A.codconta = B.CODCONTA", $condicao, ($start+1), $end, "codigo");
            $d = new ArrayIterator($dados);
            $tr = $consulta->PDOQtderegistro("ZPortarePlanocontas A WITH (NOLOCK) JOIN CCONTA B ON A.codconta = B.CODCONTA", $condicao); // Total de registros
