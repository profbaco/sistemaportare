    ...
    <div class="panel-body">
        ...
        <table class="table table-condensed table-striped">
            ...
            while ($dcontas->valid()){
                ...
                $saldoconta = $consulta->PDOSelecionarPadrao("sum(saldo) saldo", "ZPortareViewContas", "data BETWEEN '".$datainicial."' AND '".$datafinal."' AND codigo like '".$valorcontas->codigo."%' and codccusto = '".$placa."'");
