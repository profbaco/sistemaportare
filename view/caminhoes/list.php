        ...
        <table class="table table-hover table-condensed">
            ...
            while ($d->valid()){
                ...
                echo '<tr id="'.$path.$m->PLACA.'">
                                ...
                                <td>'.$m->MODELO.'</td>
                                <td>'.$m->VENCIPVA.'</td>
                                <td>'.number_format($m->KMATUAL, 0, ',', '.').'</td>
                                <td>'.number_format($m->KMPORLITRO, 2, ',', '.').'</td>
                                <td>'.$m->COMBUSTIVEL.'</td>
                                <td>
                                    ...
                                    <a href="javascript:void(0)"  onclick="CarregarAgregados(\''.$m->PLACA.'\' , \'caminhoes\')" class="btn btn-warning btn-xs" rel="tooltip" title="Agregados">
